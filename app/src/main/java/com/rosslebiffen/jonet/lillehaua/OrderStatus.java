...
import com.rosslebiffen.jonet.lillehaua.ViewHolder.FoodViewHolder;
import com.rosslebiffen.jonet.lillehaua.ViewHolder.OrderViewHolder;
...
public class OrderStatus extends AppCompatActivity {
   ...
   public RecyclerView.LayoutManager layoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logRef = db.getReference("Logbook");
    ...
    private void loadOrders(String phone) {
        ...
        Query getOrderByUser2 = logRef.orderByChild("phone")
                .equalTo(phone);

        FirebaseRecyclerOptions<Request>orderOptions2 = new FirebaseRecyclerOptions.Builder<Request>()
                .setQuery(getOrderByUser2,Request.class)
                .build();

        adapter = new FirebaseRecyclerAdapter<Request, OrderViewHolder>(orderOptions2) {
            @Override
